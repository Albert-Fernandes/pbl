...
namespace TomaRemedio.Controllers
{
    public class ReceitasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Data,Clinica,Medico,Especialidade")] Receita receita)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Data,Clinica,Medico,Especialidade")] Receita receita)
        {
            if (ModelState.IsValid)
            {
