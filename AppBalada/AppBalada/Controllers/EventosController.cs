...
namespace AppBalada.Controllers
{
    public class EventosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EventoId,Nome,Data,Inicio,Fim,IsRestrito")] Evento evento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EventoId,Nome,Data,Inicio,Fim,IsRestrito")] Evento evento)
        {
            if (ModelState.IsValid)
            {
